        ...
        <div className="space-y-4">
          {news.map((n, i) => (
            <a
              ...
              className="bg-card rounded-xl border border-border p-6 flex flex-col md:flex-row md:items-center gap-4 hover:shadow-lg transition-shadow group cursor-pointer no-underline"
            >
