                          ...
                          <div className="aspect-[3/4] bg-muted overflow-hidden flex items-center justify-center">
                            {member.photo_url ? (
                              <img
                                ...
                                className="h-full w-full object-cover object-center origin-bottom scale-125 group-hover:scale-[1.32] transition-transform duration-500"
                              />
                            ) : (
                ...
                <div className="flex items-start gap-4">
                  {selected.photo_url && (
                    <img
                      ...
                      className="w-20 h-24 rounded-md object-cover object-center origin-bottom scale-125 flex-shrink-0"
                    />
                  )}
                  <div>
